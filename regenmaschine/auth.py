...
class Authenticator(api.BaseAPI):
    ...
    @classmethod
    def create_local(cls, ip_address, password, port=8080, session=None):
        """ Creates a local authenticator"""
        klass = cls(API_LOCAL_BASE.format(ip_address, port), False, session)
